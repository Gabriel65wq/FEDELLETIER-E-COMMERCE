    ...
    <section id="inicio">
      <div className="container">
        <div className="left">
          ...
          <p>
            Soy importador directo! Mayorista y Minorista de <span className="animated-text">productos.</span> Ofrezco
            productos innovadores y de alta calidad para satisfacer tus necesidades. También trabajamos con retiros al
            domicilio y envíos por Vía Cargo.
          </p>
        ...
        <div className="right">
          <img
            ...
            alt="Foto de perfil de Fede Lettier, importador directo"
